...
import { runAddressChangeDetection } from "@/lib/logistics/delivery-tracker";
...
export async function POST(request: Request) {
  ...
  const outcome = await runJob("address-change-detection", () =>
    runAddressChangeDetection({ limit, sinceHours })
  );
